...
/** 普通状态下标题按钮文字的字体，默认为 */
@property (nonatomic, strong) UIFont *titleFontStateNormal;
/** 选中状态下标题按钮文字的字体，默认为 */
@property (nonatomic, strong) UIFont *titleFontStateSelected;
/** 选中状态下标题按钮背景的颜色，默认为红色 */
@property (nonatomic, strong) UIColor *titleBackColorStateNormal;
/** 普通状态下标题按钮背景的颜色，默认为黑色 */
@property (nonatomic, strong) UIColor *titleBackColorStateSelected;
/** 指示器颜色，默认为红色 */
...
/**
 是否全部显示头部小红点
 */
@property (nonatomic, assign) BOOL isHiddenAllTrackPoint;
/**
 在某一个位置是否显示小红点
